...
export const Project = () => {
  const portfolioProjects = [
    ...
    {
      title: "Project 4",
      Subtitles: "Subtitle for Project 4",
      ...
      <div className="container mx-auto px-4 ">
        ...
        <div className="flex flex-col mt-10 md:mt-20 gap-20">
          {portfolioProjects.map((project) => (
            <div
              key={project.title}
              className="bg-gray-800 rounded-3xl relative z-0 overflow-hidden after:z-10 after:content-[''] after:absolute after:inset-0 after:outline-2  after:outline-offset-5 after:rounded-3xl px-8 pt-8 md:pt-12 md:px-10 lg:pt-16 lg:px-20 after:pointer-events-none"
            >
